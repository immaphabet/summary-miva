...
<head>
    ...
    <style>
        ...
        body { 
            ...
            margin: 0; 
            padding: 0; 
            /* 🎨 Fetched a high-quality global tech grid background graphic to back up the interface */
            background: #f1f5f9 url('https://unsplash.com') no-repeat center center fixed;
        ...
        /* ⚪ Professional White Introduction Card */
        ...
        /* 👨‍💻 Premium Developer Profile Avatar Styling */
        ...
        /* 📋 Expanded Platform Functions Features Card Layout */
        ...
        /* 📜 Academic Consent Agreement Box */
        ...
        /* 🎬 CSS Keyframe Timelines for Dynamic Slide-In */
        @keyframes popAvatar {
        ...
        /* Classes triggered instantly by JavaScript on page load */
        ...
        /* 🔵 Premium Dark Theme Summarizer Dashboard Workspace */
...
<body>
    ...
    <!-- ⚪ STAGE 1: DYNAMIC ANIMATED WELCOME CARD -->
    <div id="intro-screen">
        ...
        <!-- 📋 Miva-Styled Platform Functionalities Checkbox Box Section -->
        <div id="features-box" class="features-box">
            <div class="features-title">🛠️ Core Platform Functions:</div>
            <div class="feature-item"><span class="feature-icon">✓</span> Stay abreast of complex lecture modules by converting heavy reading slides into crisp study briefings.</div>
            <div class="feature-item"><span class="feature-icon">✓</span> Rapidly extract key vocabulary terms, core assignment contexts, and exam-prep text highlights.</div>
            <div class="feature-item"><span class="feature-icon">✓</span> Fully integrated login-free utility interface optimized directly for desktop and mobile web layout viewports.</div>
        </div>
    ...
    <!-- Dynamic JavaScript Animation Controllers -->
    <script>
        window.addEventListener("DOMContentLoaded", function() {
            {% if summary %}
             ...
             // Clear the image background graphic during internal text summarization work
