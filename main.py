...
<head>
    ...
    <style>
        /* 🌌 Premium AMOLED Jet-Black Mode Reset */
        body { 
            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; 
            margin: 0; padding: 0; background: #000000; color: #ffffff; 
            min-height: 100vh; display: flex; flex-direction: column; 
            align-items: center; justify-content: flex-start; overflow-x: hidden; 
        }
        
        /* 🤖 Minimalist Workspace Layout */
        #app-screen { 
        ...
        .workspace-body { 
            ...
            padding-bottom: 140px; margin-top: 20px; width: 100%; 
        }
        
        /* 💬 Oversized Dynamic Gemini Typeface Heading Row */
        .gemini-greeting { 
            font-size: 38px; font-weight: 400; line-height: 1.25; color: #ffffff; 
            letter-spacing: -1px; margin-bottom: 35px; text-align: left; max-width: 95%; 
        }
        
        /* Conversational Bubble Output Feed Container */
        ...
        /* Embedded Presentation Slide Image Frame Bubble */
        ...
        /* 📥 Bottom-Docked Minimalist Floating Input Console Anchor */
        ...
        /* ✨ Grok-Styled Fixed Developer Disclosure Subline Tag */
        ...
        .action-send-btn { width: 40px; height: 40px; background: #38bdf8; border: none; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; color: #000000; font-weight: bold; font-size: 16px; flex-shrink: 0; transition: 0.2s; }
        .action-send-btn:hover { background: #7dd3fc; }
    </style>
</head>
<body>

    <!-- 🤖 MINIMALIST DARK-MODE CONSOLE MAIN DASHBOARD -->
    <div id="app-screen">
        <div class="workspace-body">
            
            <!-- 💬 Large Minimalist Gemini Greeting Heading Text Row -->
            <div class="gemini-greeting">I can help compress, study, review & more. What should we do?</div>
            
            <div class="output-stream">
                <!-- Inline Image Presentation Slideshow view block context -->
                <div id="deck-preview-bubble" style="display:none; width: 100%;">
                    <div class="slide-bubble" id="display-frame">
                        <span style="color:#475569;">Assembling material elements...</span>
                    </div>
                ...
                <!-- Text Briefing output display presentation bubble -->
                <div class="ai-markdown-bubble" id="response-block">
                    {{ summary }}
                </div>
            </div>
        ...
        <!-- 📥 Bottom-Docked Input Console Area with Fixed Disclosure Credit Line -->
        <div class="bottom-dock">
            
            <!-- ✨ Centered Disclosure Placement Target: Developed by Emmanuel Olorunjuwonlo -->
            ...
            <div class="console-pill">
                <form method="POST" enctype="multipart/form-data" id="engine-form" style="margin:0; display:flex; flex-direction:column; gap:6px;">
                    ...
                    <div class="file-upload-row">
                        <input type="file" name="slide_images" multiple accept="image/*" onchange="loadSlidesPreview(this)" required>
                    </div>
    ...
    <script>
        // 🖼️ SLIDESHOW PREVIEW CORE CACHE LOGIC
