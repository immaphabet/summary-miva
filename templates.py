...
<head>
    ...
    <style>
        ...
        input[type="password"] { width: 80%; padding: 12px; background: #000000; border: 1px solid #1e293b; color: #ffffff; border-radius: 8px; margin-bottom: 12px; font-size: 16px; text-align: center; }
        button { background: #38bdf8; color: #000000; border: none; padding: 12px 30px; border-radius: 8px; font-weight: bold; cursor: pointer; }
    </style>
</head>
<body>
    <div class="container">
